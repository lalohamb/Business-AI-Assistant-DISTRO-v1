...
- clients/templates/: BUSINESS_PROFILE.md, OWNER_PREFERENCES.md, BUSINESS_KNOWLEDGE.md, FAQ.md, PROCEDURES/{EMAIL,CALENDAR,DAILY_BRIEFING,DOCUMENTS}.md, MEMORY/{CUSTOMER_RULES,VENDOR_RULES,LEARNED_PATTERNS,OPEN_TASKS,TODAY}.md
